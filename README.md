...
当前进度：主领域包括 **二进制逆向分析**（概念 + ELF 鉴定交叉 + **Ghidra/radare2/IDA MCP/Frida 本机安装**）、**微信小程序**、**UniApp 产物工具地图**（概念）、**Android Flutter AOT / Blutter**、**Hydra/Medusa**（概念）、**mitmproxy 安装**。基础底座、威胁情报、身份认证、Web 安全、网络安全与流量分析为部分覆盖。
